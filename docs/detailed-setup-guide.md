...
> **⚠️ IMPORTANT:** This guide is for ROS 2 Jazzy on Ubuntu 24.04. For ROS 2 Humble (Ubuntu 22.04), please use the `ros2-humble` branch.
...
Note: This step is only for PC. Gazebo Harmonic is used in ROS 2 Jazzy.
...
* Q. Is Ubuntu 22.04 supported?
  * A. No. Ubuntu 24.04 only for ROS 2 Jazzy.
* Q. Is ROS 2 Humble supported?
  * A. No. ROS 2 Jazzy only on this branch. Use `ros2-humble` branch for Humble support.
* Q. Is ROS 2 Foxy/Galactic/Humble supported?
