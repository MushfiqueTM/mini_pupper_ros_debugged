...
#
# Description: You can use the following FPC(Flexible Programmable
#              Choreography) APIs to define your Mini Pupper to dance.
...
#                 Level 3(for beyond): Samples delicately control the foot
#                    locations, move speed, and attitudes at each
#                    execution time.
#
